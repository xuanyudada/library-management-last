<template>
  <div>
    <div style="margin-bottom: 20px">
      ...
      <el-input style="width: 240px;margin-left: 5px" placeholder="请输入图书标准码" v-model="params.userName"></el-input>
    ...
    <el-table :data="tableData" stripe  row-key="id" default-expand-all>
      ...
      <el-table-column prop="bookName" label="图书名称" width="80"></el-table-column>
      <el-table-column prop="bookNo" label="图书标准码" width="80"></el-table-column>
